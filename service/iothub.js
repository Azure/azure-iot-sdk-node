 ...
 * A messaging {@link Client} using either AMQP or AMQP over Websockets that enables:
 ...
 *
 * It also supports Device identity registry operations with the {@link Registry} object:
 * - creating, removing, updating, and listing device identities registered with an IoT hub
 * - get and update and query device twins
 * 
 * Finally, the `{@link JobClient} object allows to schedule long running tasks that:
