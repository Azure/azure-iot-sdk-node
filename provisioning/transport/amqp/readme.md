This package (**azure-iot-provisioning-device-amqp**) provides the AMQP and AMQP over Websocket transports that can be used to communicate with the Azure IoT Hub Device Provisioning Service. Please note that the AMQP transport supports both X509 and TPM authentication.
