...
export class ProvisioningServiceClient {
  ...
  /**
   * @summary Creates a query that can be used to return, for and EnrollmentGroup pages of existing device registration status.
   * @param querySpecification The query specification.
   * @param enrollmentGroupId The EnrollmentGroup that provides the scope for the query.
   * @param pageSize The maximum number of elements to return per page.
   */
  createEnrollmentGroupDeviceRegistrationStatusQuery(querySpecification: QuerySpecification, enrollmentGroupId: string, pageSize?: number): Query {
