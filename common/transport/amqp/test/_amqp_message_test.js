...
describe('AmqpMessage', function () {
  describe('#fromMessage', function () {
    ...
    /*Tests_SRS_NODE_IOTHUB_AMQPMSG_05_002: [The created AmqpMessage object shall NOT have a property of type Object named properties.]*/
    it('does NOT create a properties object on the AmqpMessage object', function () {
      var amqpMessage = AmqpMessage.fromMessage(new Message());
      assert.notProperty(amqpMessage, 'properties');
    });
