...
describe('AmqpMessage', function () {
  describe('#fromMessage', function () {
    ...
    /*Tests_SRS_NODE_IOTHUB_AMQPMSG_26_001: [If diagnostics is truthy, the AmqpMessage object shall set message annotation of diagnostic properties.]*/
    ...
    /*Tests_SRS_NODE_IOTHUB_AMQPMSG_26_002: [If diagnostics is falsy, the AmqpMessage object shall not set message annotation of diagnostic properties.]*/
