...
describe('endpoint', function() {
  [
    ...
    },
    {
      ...
      actual: endpoint.deviceBlobUploadNotificationPath(
        deviceId,
        'correlationId'
      )
    },
    {
      ...
      expected:
        '/devices/mydevice/messages/devicebound/55E68746-0AD9-4DCF-9906-79CDAC14FFBA',
      actual: endpoint.deviceFeedbackPath(
        deviceId,
        '55E68746-0AD9-4DCF-9906-79CDAC14FFBA'
      )
    },
    {
      name: 'modulePath',
