...
const errorCallbackToPromise = require('../dist/promise_utils')
  .errorCallbackToPromise;
const noErrorCallbackToPromise = require('../dist/promise_utils')
  .noErrorCallbackToPromise;
const doubleValueCallbackToPromise = require('../dist/promise_utils')
  .doubleValueCallbackToPromise;
const tripleValueCallbackToPromise = require('../dist/promise_utils')
  .tripleValueCallbackToPromise;
const httpCallbackToPromise = require('../dist/promise_utils')
  .httpCallbackToPromise;
...
describe('PromiseUtils', function() {
  describe('#callbackToPromise', function() {
    ...
    it('throws when an Error is thrown', function() {
      ...
      callbackToPromise(functionWithCallback).then(
        res => assert.fail(res),
        err => assert.isDefined(err)
      );
    });
    ...
    it('returns undefined result for empty callback', function(done) {
      ...
      callbackToPromise(functionWithEmptyPromise)
        .then(result => {
    ...
    it('returns simple value properly when callback invoked', function(done) {
      ...
      callbackToPromise(functionWithSimpleResult)
        .then(result => {
    ...
    it('returns complex object properly when callback invoked', function(done) {
      ...
      callbackToPromise(functionWithComplexResult)
        .then(result => {
    ...
    it('returns complex object properly from long running operation', function(done) {
      const returnValue = {
        key: 'value',
        id: 42
      };
    ...
    it('rejects when only error returned', function(done) {
      ...
      callbackToPromise(functionWithEmptyPromise).then(
        result => {
          done(result);
        },
        err => {
    ...
    it('returns empty result when action completed successfully and no result returned', function(done) {
      ...
      callbackToPromise(functionWithErrorOnly)
        .then(result => {
          assert.isUndefined(result);
          done();
        })
  ...
  describe('#errorCallbackToPromise', function() {
    ...
    it('returns empty result when action completed successfully and no result returned', function(done) {
      ...
      errorCallbackToPromise(functionWithErrorOnly)
        .then(result => {
          assert.isUndefined(result);
          done();
        })
  ...
  describe('#noErrorCallbackToPromise', function() {
    ...
    it('returns value when callback invoked', function(done) {
      ...
      noErrorCallbackToPromise(functionWithValueReturnOnly)
        .then(result => {
  ...
  describe('#doubleValueCallbackToPromise', function() {
    it('executes user callback when passed', function(done) {
      ...
      const promise = doubleValueCallbackToPromise(
    ...
    it('rejects when the first argument in callback is an error', function(done) {
      ...
      doubleValueCallbackToPromise(
        functionWithErrorAsFirstParameter,
        undefined
      ).then(
        _ => {
    ...
    it('rejects when the second argument in callback is an error', function(done) {
      ...
      doubleValueCallbackToPromise(
        functionWithErrorAsSecondParameter,
        undefined
      ).then(
        _ => {
          done('The promise should be rejected');
    ...
    it('returns single value when callback is invoked', function(done) {
      ...
      const packFunction = (error, value) => {
        return value;
      };
    ...
    it('returns packed result when callback returns two values', function(done) {
      ...
      const packFunction = (value1, value2) => {
        return { return1: value1, return2: value2 };
      };

      doubleValueCallbackToPromise(functionWithTwoReturnValues, packFunction)
        .then(result => {
          assert.deepEqual(result, returnValue);
          done();
        })
  ...
  describe('#tripleValueCallbackToPromise', function() {
    it('executes user callback when passed', function(done) {
      ...
      const promise = tripleValueCallbackToPromise(
        functionWithCallback,
        undefined,
        callback
      );
    ...
    it('returns packed result when callback returns two values', function(done) {
      ...
      tripleValueCallbackToPromise(functionWithTwoReturnValues, packFunction)
        .then(result => {
          assert.deepEqual(result, returnValue);
          done();
        })
