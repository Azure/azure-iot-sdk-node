...
describe('errors', function() {
  [
    ...
    it(
      ErrorCtor.name + " inherits from the standard javascript 'Error' object",
      function() {
    ...
    it(
      ErrorCtor.name +
        ' accepts a message as a constructor argument and populates its message property with it',
      function() {
