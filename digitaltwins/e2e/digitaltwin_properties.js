  ...
  it('device can report a property and service client read it.', function (done) {
    ...
    digitalTwinClient.register()
      ...
      .then((serviceTwin) => {
        ...
        if (serviceTwin.components[componentName].properties.readOnlyProperty &&
            serviceTwin.components[componentName].properties.readOnlyProperty.reported &&
            serviceTwin.components[componentName].properties.readOnlyProperty.reported.value) {
          currentValueOfProperty = serviceTwin.components[componentName].properties.readOnlyProperty.reported.value;
        }
