...
/**
 * @export
 * @type DigitalTwinUpdateDigitalTwinResponse   Type alias to simplify the auto generated type's name
 */
export type DigitalTwinUpdateDigitalTwinResponse = Models.DigitalTwinUpdateDigitalTwinResponse | undefined;
...
export class DigitalTwinServiceClient {
   ...
   * @returns DigitalTwinUpdateDigitalTwinResponse      The HTTPesponse.
   * @memberof DigitalTwinServiceClient
   */
  updateDigitalTwin(digitalTwinId: string, patch: any[], eTag?: string): Promise<DigitalTwinUpdateDigitalTwinResponse>;
  updateDigitalTwin(digitalTwinId: string, patch: any[], eTagOrCallback?: string | TripleValueCallback<DigitalTwin, msRest.HttpOperationResponse>, callback?: TripleValueCallback<DigitalTwin, msRest.HttpOperationResponse>): void;
  updateDigitalTwin(digitalTwinId: string, patch: any[], eTagOrCallback?: string | TripleValueCallback<DigitalTwin, msRest.HttpOperationResponse>, callback?: TripleValueCallback<DigitalTwin, msRest.HttpOperationResponse>): void | Promise<DigitalTwinUpdateDigitalTwinResponse> {
    ...
    return tripleValueCallbackToPromise<void, msRest.HttpOperationResponse, DigitalTwinUpdateDigitalTwinResponse>((_callback) => {
    ...
    }, (result, response) => createResultWithHttpOperationResponse<void, DigitalTwinUpdateDigitalTwinResponse>(result, response), actualCallback as TripleValueCallback<void, msRest.HttpOperationResponse>);
  }
   ...
   * @returns DigitalTwinResponse             The return object containing the component plus the HttpResponse.
   * @memberof DigitalTwinServiceClient
   */
