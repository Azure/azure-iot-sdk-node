  ...
  describe('#uploadToBlob', function () {
    ...
    it('sets the require for storage blob', function (done) {
      ...
      sinon.stub(storageblob,"BlockBlobClient").callsFake(function fakeFn() {
        function uploadStreamFn(_stream, _bufferSize, _maxConcurrency, _options) {
    ...
    /*Tests_SRS_NODE_DEVICE_BLOB_UPLOAD_16_005: [`uploadToBlob` shall call the `done` callback with the result of the storage api call.]*/
