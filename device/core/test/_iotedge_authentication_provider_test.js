...
let WORKLOAD_API_VERSION = require('../dist/iotedge_authentication_provider').WORKLOAD_API_VERSION;
...
describe('IotEdgeAuthenticationProvider', function () {
  ...
  describe('#getTrustBundle', function () {
    ...
    it('uses http.request object', function (testCallback) {
      ...
      provider.getTrustBundle(function (err, _ca) {
        assert.isNotOk(err);
        testCallback();
      });
    });
  ...
  describe('#sign', function () {
    ...
    it('builds request path in expected format', function (testCallback) {
      ...
      provider._sign('data', 100000, function (_err) {
        testCallback();
      });
    });
    ...
    it('signs request is as expected', function (testCallback) {
      ...
      provider._sign('data', 2000, function (_err) {
        testCallback();
      });
    });
