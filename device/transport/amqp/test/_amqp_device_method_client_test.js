...
const AmqpDeviceMethodClient = require('../dist/amqp_device_method_client.js').AmqpDeviceMethodClient;
...
describe('AmqpDeviceMethodClient', function () {
  ...
  describe('#constructor', function () {
    ...
    it('inherits from EventEmitter', function () {
      const client = new AmqpDeviceMethodClient({}, {});
  ...
  describe('#onDeviceMethod', function () {
    ...
    [undefined, null, ''].forEach(function (badMethodName) {
      it('throws a ReferenceError if the \'methodName\' parameter is \'' + badMethodName + '\'', function () {
        const client = new AmqpDeviceMethodClient(fakeAuthenticationProvider, {});
    ...
    it('saves the callback argument and calls it with a DeviceMethodRequest when a method request message is received', function (testCallback) {
      const fakeAmqpReceiver = new EventEmitter();
      const fakeMethodName = 'testMethod';
      const fakeMethodRequest = new AmqpMessage();
      ...
      const client = new AmqpDeviceMethodClient(fakeAuthenticationProvider, fakeAmqpClient);
    ...
    },
    {
      ...
      it('uses the right link parameters when moduleId is ' + testConfig.moduleId, function (testCallback) {
        ...
        const client = new AmqpDeviceMethodClient(authProvider, fakeAmqpClient);
        client.attach(function () {
  ...
  describe('#sendMethodResponse', function () {
    ...
    - The `body` property of the message must be set to the value of the `methodResponse.payload` property.]*/
  ...
  describe('#attach', function () {
    ...
    it.skip('emits an error event if an error is received after establishing the link', function (testCallback) {
      ...
      const fakeAmqpSender = new EventEmitter();
      fakeAmqpSender.detach = sinon.stub().callsArg(0);
      const fakeError = new Error('failed to establish sender link');
      const fakeAmqpClient = {
  ...
  describe('#detach', function () {
    ...
    it('immediately calls the callback if already detached', function (testCallback) {
      const fakeSenderLink = new EventEmitter();
