...
From the `getting_started/connections` directory, run `node connection_string.js`
...
From the `getting started/connections` directory, run `node sas.js`
...
From the `getting_started/connections` directory, run `node x509.js`
...
From the `getting_started/connections` directory, run `node proxy.js`
