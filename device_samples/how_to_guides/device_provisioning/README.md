...
From the `homw_to_guides/device_provisioning` directory, run `node register_symkey.js`
...
From the `homw_to_guides/device_provisioning` directory, run `node register_symkeygroup.js`
